    ...
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        <ol id="wd-pancakes">
          ...
          <li>lip and cook the other side.</li>
          <li>Serve and enjoy!</li>
        </ol>
        My favorite recipe:
        <ol id="wd-your-favorite-recipe">
          <li>Beat the eggs.</li>
          <li>Preheat the pan with low heat.</li>
          <li>Melt a little butter inside the pan.</li>
          <li>Pour in the egg mixture.</li>
          <li>Pull a rubber spatula across the bottom of the pan.</li>
          <li>
            Stir the eggs every few seconds, and prevent any part of the eggs
            from drying out.
          </li>
          <li>
        ...
        <ul id="wd-your-books">
          ...
          <li>Journy Under the Midnight Sun</li>
        </ul>
      </div>
      <div id="wd-tables">
        <h4>Table Tag</h4>
      ...
      <div id="wd-images">
        ...
        <img
          id="wd-maldives"
          width="400px"
          src="https://www.africaodyssey.com/site/odyssey-image-proxy/country/maldives=403724-300.jpg"
        />
        <br />
        Loading a local image:
        <br />
        <img
          id="wd-maldives-best-hotel"
          src="/images/Nova-Maldives-lead-1368x636.jpg"
          height="100px"
        />
      </div>
      <div id="wd-forms">
        ...
        <form id="wd-text-fields">
          ...
          <h5>Select one</h5>
          <label htmlFor="wd-select-one-genre">Facorite movie genre: </label>
          <br />
